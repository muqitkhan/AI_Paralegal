    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-center px-16 text-white">
        <div className="flex items-center gap-3 mb-8">
          ...
          <h1 className="text-4xl font-bold">AI Paralegal</h1>
        </div>
        <p className="text-xl text-blue-200 mb-12">
          Automate your legal practice with AI-powered tools
        </p>
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <div className="lg:hidden flex items-center gap-2 mb-6 justify-center">
              ...
              <h1 className="text-2xl font-bold text-slate-800">AI Paralegal</h1>
            </div>
